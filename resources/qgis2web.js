...
map.getView().fit([-11503117.824881, 2320363.842689, -11451072.975233, 2367865.359563], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Mapa de Iglesias, templos y parroquias:  El Salto, Juanacatlán y Zapotlanejo - Ramiro Corona</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_Iglesias_Juanacatln_9,
    colName: 'nom_estab',
    zoom: 10,
    collapsed: true,
    map: map,
